...
class I2C_SSD1306_WITH_M5GFX  : public M5GFX
{
...
public:
  ...
  I2C_SSD1306_WITH_M5GFX (const config_t &cfg)
  {
  ...
  I2C_SSD1306_WITH_M5GFX (uint8_t pin_sda = GENERIC_SSD1306_SDA, uint8_t pin_scl = GENERIC_SSD1306_SCL, uint32_t i2c_freq = GENERIC_SSD1306_FREQ, int8_t i2c_port = -1, uint8_t i2c_addr = GENERIC_SSD1306_ADDR)
  {
